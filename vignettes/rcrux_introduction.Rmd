...
```{r add blast path to get_seeds_local()}
get_seeds_local(forward_primer_seq,
  reverse_primer_seq,
  output_directory_path,
  metabarcode_name,
...
```{r specify blast path for blast_seeds()}
